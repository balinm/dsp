...
p_frat = 1/ 125
p_ident = 1 / 300
elvis = thinkstats2.Pmf()
elvis.Set('Fraternal', p_frat)
elvis.Set('Identical', p_ident)
elvis.Normalize()
elvis.Prob('Identical') * 100
The probabilty that Elvis was an indentical twin is 29.41%
